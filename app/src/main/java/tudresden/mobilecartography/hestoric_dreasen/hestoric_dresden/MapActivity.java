...
public class MapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(
                new LatLng(51.051877, 13.741517), 15));
//        mMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(
//                R.drawable.star
//        )).position(new LatLng(51.02855, 13.723903)).anchor(0.5f, 0.5f).title("HUL/S590")
//                .snippet("Computer Pool"));
        mMap.addCircle(new CircleOptions().center(new LatLng(51.051877, 13.741517))
